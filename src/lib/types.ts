...
/** A single indexed page within a project. */
export interface DocumentRecord {
  /** Globally unique namespaced ID: "<project>:<sphinxDocIndex>". */
  id: string;
  project: string;
  /** sphinx docname, e.g. "api/circuits" */
  filename: string;
  title: string;
  url: string;
}

/** Maps a section heading to its containing document and anchor. */
export interface TitleEntry {
  /** The document ID that contains this section. e.g. "tket:42" */
  docId: string;
  /** In-page anchor fragment, null for page root */
  anchor: string | null;
}


/**
 * Root schema of `public/combined-searchindex.json` (version "1").
 * Generated by `scripts/combine-search-indexes.ts`; consumed by
 * `src/lib/search-index.ts` at server startup.
 */
...
export interface SearchResult {
  ...
  matchedTerms: string[];
  /**
   * Matched sub-page sections in index-iteration order.
